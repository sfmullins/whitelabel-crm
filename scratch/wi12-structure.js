...
for(const temporaryWorkflow of ['.github/workflows/wi12-patch.yml','.github/workflows/wi12-one-shot-fix.yml','.github/workflows/wi12-stabilization-export.yml','.github/workflows/wi12-stabilization-apply.yml'])if(fs.existsSync(path.join(root,temporaryWorkflow)))throw new Error(`Temporary WI12 workflow remains in source: ${temporaryWorkflow}`);
