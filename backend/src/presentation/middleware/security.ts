...
function permissionFor(method:string,path:string):string|null{
  ...
  if(path.startsWith('/reporting')){if(path.includes('/export'))return 'reports.export';return method==='GET'?'reports.read':'reports.manage';}
